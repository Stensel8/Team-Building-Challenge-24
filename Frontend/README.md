# Handmatige installatie van de SaxCoin REST Frontend server
...
## 5. Run Frontend 
Run in map Frontend op port 8080, haal eerst IP backend op, in ons geval (als je de handleiding gevolgd hebt), is dit 192.168.20.105 en/of 192.168.20.110 Backend port, bijv. 5000. Dan wordt het:
```sh
    SAXCOIN_BACKEND="http://192.168.20.115:5000"
    export SAXCOIN_BACKEND
    poetry run gunicorn app:app --bind 0.0.0.0:8080
```
